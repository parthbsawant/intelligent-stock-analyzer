...
# # ----------------------------------------
# # 🔷 ALL SERVICE IMPORTS AT TOP (FIXED)
# # ----------------------------------------
...
#     fetch_news
# )
# from services.sentiment import get_overall_sentiment   # 🔥 MOVED TO TOP
# from services.nlp import process_news                  # 🔥 UNCOMMENTED & MOVED TO TOP
...
#     return COMPANY_MAP.get(base_symbol, base_symbol)
...
#     # 🔥 Sentiment using imported function (now safe)
...
#     # 🔥 Step 2: Sentiment on same news list (same order = safe index mapping)
#     try:
#         sentiment_result = get_overall_sentiment(news)
...
#         # Don't crash — return events with neutral fallback
